    ...
    <div className='container m-auto'>
      ...
      <div className=" mx-8 w-full">
        <div className='px-2 w-full'>
          ...
          <textarea type="address" id="address" name="address" cols="10" rows="2" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" ></textarea>
        </div>
      </div>
      ...
      {/* <div className='flex mx-8'>
        <Link href={''}><button className="flex m-1 text-white bg-pink-300 border-0 py-1 px-1 focus:outline-none hover:bg-pink-600 rounded text-sm"> Pay {subTotal}</button></Link>
      </div> */}
    </div>
  )
}
